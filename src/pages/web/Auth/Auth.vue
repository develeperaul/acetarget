    ...
    auth(button) {
      apiAuth
        ...
        .then(({ data }) => {
          ...
          this.$store.dispatch("user/fetchInfo").then(() => {
            console.log("3");
